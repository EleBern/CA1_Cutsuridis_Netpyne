...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 ANSynapse C:/Users/ely97/Documenti/00 Doc/Uni/NY_Internship/Cutsuridis model/CA1-NetPyNE-model-master/ANsyn.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "ANsyn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
