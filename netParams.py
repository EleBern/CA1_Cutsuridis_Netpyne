...
# FPATT = "Weights/pattsN100S20P10.dat"	#already stored patterns: each column is a pattern. Each line is a CA1 pyramidal cell
# PATTS = np.transpose(np.loadtxt(fname=FPATT, dtype='int16')) #each column is a pattern - 100 lines (one per pyramidal cell)
...
# # sim.save.saveData(include='netParams')