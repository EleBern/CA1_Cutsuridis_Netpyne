...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 8, "ks_ion");
 	...
 	ivoc_help("help ?1 ichan2 C:/Users/ely97/Documenti/00 Doc/Uni/NY_Internship/Cutsuridis model/CA1-NetPyNE-model-master/ichan2.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "ichan2.mod";
static const char* nmodl_file_text = 
  "TITLE ichan2.mod  \n"
  " \n"
  "COMMENT\n"
