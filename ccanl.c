...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 12, "cvodeieq");
 	...
 	ivoc_help("help ?1 ccanl C:/Users/ely97/Documenti/00 Doc/Uni/NY_Internship/Cutsuridis model/CA1-NetPyNE-model-master/ccanl.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "ccanl.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
